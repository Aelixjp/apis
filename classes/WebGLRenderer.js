export default class WebGLRenderer
{
    ...
    main()
    {
        ...
        this.#texture = this.loadTexture(this.#gl, "images/cubetexture.png");
    ...
    initBuffers(gl) {
        ...
        const textureCoordBuffer = gl.createBuffer(); gl.bindBuffer(gl.ARRAY_BUFFER, textureCoordBuffer);
